...
contains functions needed to see whether occupations are green or not. This script utilises the SOCMapper class described above.

## 🔨 Core functionality

To map job titles in job adverts to the green measures described above, we developed the `OccupationMeasures` class. This can be used in the following way:
