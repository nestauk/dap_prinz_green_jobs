...
def get_green_industry_measure(
    ...
    ghg_emissions_dict: Dict[str, float],
    ghg_unit_emissions_dict: Dict[str, float],
    ojo_companies_house_dict: Dict[str, Dict[str, str]] = ojo_companies_house_dict,
    ...
    Args:
        ...
        ghg_emissions_dict (Dict[str, float]): Dictionary of SIC codes and total GHG emissions
        ghg_unit_emissions_dict (Dict[str, float]): Dictionary of SIC codes and GHG emissions per unit of economy activity
